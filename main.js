...
Was ist ein Inkrement?;Ein Inkrement ist ein ausführbarer Teil des Produktziels und muss ausführbar sein.;Ein Inkrement ist eine vollständige Neuimplementierung des gesamten Produkts.;Ein Inkrement ist ein Dokument, das alle Änderungen am Produkt beschreibt.
...
Welche Aufgabe haben Stakeholder im Scrum-Prozess?; Stackholder sind Personen oder Gruppen die von der Entwicklung und Veröffentlichung des Produks Betroffen sind (Kunden, Benutzer, Management, Marketingteams, Kundenbetreuer, oder andere Interessengruppen). Sie treffen alle Entscheidungen zur technischen Implementierung des Produkts.;Sie unterstützen das Team und den Product Owner durch Feedback und die Kommunikation von Anforderungen.;Sie sind für das tägliche Management der Scrum-Meetings verantwortlich.
Was ist Empirie?; Empirie bedeutet, dass Wissen aus Erfahrung gewonnen wird und Entscheidungen auf der Grundlage von Beobachtungen getroffen werden.; Empirie bedeutet, dass altes Wissen genutz wird um Entscheidungen zu treffen und man sich nicht durch neue Ereignisse beeinflussen lässt; Empirie ist eine Methode in der eine Person alle Entscheidungen trifft und über alle anderen bestimmt
Was bedeutet Lean Thinking?; Lean Thinking reduziert Verschwendung und fokussiert auf das Wesentliche.; Lean Thinking erhöt perfektion und fokussiert auf genaue optimierung des Produkts; Lean Thinking ist eine Methode um in Pausen den Kopf frei zu bekommen.
`
;
